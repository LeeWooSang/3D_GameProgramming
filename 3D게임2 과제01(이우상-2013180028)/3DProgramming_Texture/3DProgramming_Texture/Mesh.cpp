...
CTriangleMeshDiffused::CTriangleMeshDiffused(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
}
...
void CTriangleMeshDiffused::Render(ID3D12GraphicsCommandList *pd3dCommandList)
{
}
