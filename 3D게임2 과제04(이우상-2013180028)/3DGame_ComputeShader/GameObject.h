...
public:
	...
	D3D12_GPU_DESCRIPTOR_HANDLE GetSrvHandle(int nIndex) { return m_pRootArgumentInfos[nIndex].m_d3dSrvGpuDescriptorHandle; }
	D3D12_GPU_DESCRIPTOR_HANDLE GetUavHandle(int nIndex) { return m_pRootArgumentInfos[nIndex].m_d3dUavGpuDescriptorHandle; }
};
