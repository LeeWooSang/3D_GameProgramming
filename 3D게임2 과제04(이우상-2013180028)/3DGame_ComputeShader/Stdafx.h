...
enum OBJECT_TYPE {FRAME_PLAYER, FRAME_ENEMY, Missile};
enum UI_TPYE {FIRST_PERSON, GAMESTART, GAMEMENU, GAMEHELP, GAMEOVER, GAMERUN};
enum FONT_NUMBER { ZERO, ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE };
