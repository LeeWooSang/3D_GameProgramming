...
void CGeneralScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
...
void CGeneralScene::ReleaseObjects()
{
...
void CGeneralScene::ReleaseUploadBuffers()
{
...
ID3D12RootSignature *CGeneralScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
...
void CGeneralScene::AnimateObjects(float fTimeElapsed)
{
	for (int i = 0; i < m_nShaders; i++)
	{
...
void CGeneralScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
