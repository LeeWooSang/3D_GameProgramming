...
void CGeometryScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	CGeometryShader *pObjectShader = new CGeometryShader();
	pObjectShader->CreateShader(pd3dDevice, m_pd3dGraphicsRootSignature);
	pObjectShader->BuildObjects(pd3dDevice, pd3dCommandList, m_pTerrain);
	m_ppShaders[0] = pObjectShader;
}

void CGeometryScene::ReleaseObjects()
{
...
void CGeometryScene::ReleaseUploadBuffers()
{
...
ID3D12RootSignature *CGeometryScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[4].BaseShaderRegister = 6; //t6: gtxtSandTexture
...
void CGeometryScene::AnimateObjects(float fTimeElapsed)
{
	for (int i = 0; i < m_nShaders; i++)
	{
...
void CGeometryScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
