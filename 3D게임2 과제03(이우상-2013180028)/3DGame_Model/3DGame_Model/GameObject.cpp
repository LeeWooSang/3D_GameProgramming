...
void CMaterial::SetTextured(CTexture *pTexture)
{
...
void CMaterial::SetStandardShader() 
{ 
	CMaterial::SetShader(m_pStandardShader); 
}
...
#define _WITH_DISPLAY_TEXTURE_NAME
		...
		if (!bDuplicated)
		{
			*ppTexture = new CTexture(1, RESOURCE_TEXTURE2D, 0);
			...
			m_pShader->CreateShaderResourceViews(pd3dDevice, *ppTexture, nRootParameter, false);
		}
		else
		{
			if (pParent)
...
void CMaterial::PrepareShaders(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, int nConstantBufferViews, int nShaderResourceViews)
{
